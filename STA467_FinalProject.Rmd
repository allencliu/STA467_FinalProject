...
evalm1 <- evalm(models, gnames = names(models))
```
...
models2 <- list(Logistic = wine_logit2, LDA = wine_lda2, QDA = wine_qda2, Lasso = wine_lasso2, Ridge = wine_ridge2, Elastic = wine_elastic2, "Random Forest" = wine_tree2)
models2 <- models2[order(names(models2))]

evalm2 <- evalm(models2, gnames = names(models2))
```
